...
Please use the NES Save format when submitting - this can be generated by saving your NES model and simply exporting it via the Save, and then DownloadSave calls.