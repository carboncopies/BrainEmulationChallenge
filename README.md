...
```
cd existing_repo
git remote add origin https://gitlab.braingenix.org/carboncopies/virtual-brain/aifinch.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.braingenix.org/carboncopies/virtual-brain/aifinch/-/settings/integrations)
