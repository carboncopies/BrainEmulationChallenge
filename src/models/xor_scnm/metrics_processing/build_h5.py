...
from utils import get_latest_acquisition
...
class build_h5:
    ...
    def compute_metadata(self, data_df, cfg_df, trial_df, spikes_df):
        ...
        print("Completed Generating Metadata!")
...
if __name__ == "__main__":
    ...
    gt_acquisition = get_latest_acquisition(project_root / "output")
    output_folder = project_root / "metrics_processing" / "h5_output"
    output_folder.mkdir(parents=True, exist_ok=True)

    converter = build_h5(
        vm_csv       = gt_acquisition / "groundtruth-Vm.csv",
        spikes_csv   = gt_acquisition / "groundtruth-spikes.csv",
        net_con      = project_root / "metrics_processing" / "network_config.json",
        t_map        = gt_acquisition / "trial_map.json",
        h5_file_path = output_folder / "groundtruth.h5"
    )
