...
1. Defining an XOR logic circuit composed of ball-and-stick
   ...
   Circuit:
                ...
                +-----------> P_A0 (-30,90)-----> P_B0 (0,90)-------> P_C0 (30,90)-----+
                |                                                                      |
                +-----------> P_A1 (-30,60)-----> P_B1 (0,60)------+                   |
                |                                                  |                   |
    Cin (-60,30)+----+  +---> P_A2 (-30,30)----+                   |                   +> Sum (60,30)
                     |  |                      |                   |                   |
    P_inA (-60,0)-------+--+> I_A0 (-30,0)-----+> P_B2 (0,0)+------+> I_C0 (30,30)-----+
                     |  |  |                   |            |         
    P_inB (-60,-30)+-------+> P_A3 (-30,-30----+            |   +---> P_C1 (30,0)------+> Cout (60,-30)
                   | |  |                                   +---|--+                   |
                   | |  +---> P_A4 (-30,-60)----> P_B3 (0,-60)--+  +> P_C2 (30,-60)----+
                   | |                                          |  |
                   +--------> P_A5 (-30,-90)----> P_B4 (0,-90)--+  |
                     |                                             |
                     +------> P_A6 (-30,-120)---> P_B5 (0,-120)----+
