...
# Netmorph parameters used for par optimization. These will be used to override values in the model file, and are also stored in the experiments database for reference.
...
Parser.add_argument("-dmWeight", type=float, help="The weighting of the chosen Direction Model")
...
if Args.shapeRadius:
    modelcontent += SHAPE_RADIUS % Args.shapeRadius
if Args.shapeThickness:
    modelcontent += SHAPE_THICKNESS % Args.shapeThickness
if Args.dmWeight:
    modelcontent += DM_WEIGHT % Args.dmWeight
