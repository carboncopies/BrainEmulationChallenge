...
Parser.add_argument("-UseHTTPS", nargs="?", const=True, default=False, type=vbpcommon.ParseBool, help="Enable or disable HTTPS")
...
Parser.add_argument("-DoOBJ", nargs="?", const=True, default=False, type=vbpcommon.ParseBool, help="Netmorph should produce OBJ output")
Parser.add_argument("-DoBlend", nargs="?", const=True, default=False, type=vbpcommon.ParseBool, help="Netmorph should produce Blender output")
