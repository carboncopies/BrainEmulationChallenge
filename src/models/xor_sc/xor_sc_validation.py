...
Parser = argparse.ArgumentParser(description="BrainGenix-API Simple Python Validation Test Script")
...
print(" -- Running Edit Metrics")
EditJSON = EVM.Validation.SCValidation(ClientInstance, KTGSaveNAme, EMUSaveName)
