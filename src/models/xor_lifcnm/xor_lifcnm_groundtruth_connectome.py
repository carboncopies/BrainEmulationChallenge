#!../../../venv/bin/python
# xor_lifcnm_groundtruth_connectome.py
...
Parser.add_argument("-modelname", default="xor_lifcnm", type=str, help="Name of neuronal circuit model to save")
Parser.add_argument("-DoOBJ", nargs="?", const=True, default=False, type=vbp.ParseBool, help="Netmorph should produce OBJ output")
Parser.add_argument("-DoBlend", nargs="?", const=True, default=False, type=vbp.ParseBool, help="Netmorph should produce Blender output")
