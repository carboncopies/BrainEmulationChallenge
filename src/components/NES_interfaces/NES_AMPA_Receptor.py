...
def API_call(name: str, req: str, callback: Callable[Any, Any] | None = None):
    # TODO: This function must be implemented.
    #       Is this the right location for this function?
    pass
...
def await_API_response(name: str, id: int):
    # TODO: This function must be implemented.
    pass
...
class NES_AMPA_Receptor:
    ...
    def np_Gsyn_t_pS_mxh(self, t_ms: np.ndarray) -> np.ndarray:
        API_call("NES/AMPAR/np_Gsyn_t_pS_mxh", json.dumps({"ID": ID, "t_ms": t_ms}))
