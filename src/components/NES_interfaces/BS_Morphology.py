...
def BS_Soma(id_val: int, domain_bounds: list, align: str, radius_um=0.5) -> Sphere:
    if align == "left":
        center = (
    ...
    return Sphere(id_val, center, radius_um)
...
def BS_Axon(
    ...
    return Cylinder(id_val, end0, end0_radius_um, end1, end1_radius_um)
